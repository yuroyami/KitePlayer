 ...
 *
 * The JVM once ran no real media, because KiteFFmpeg's jvm variant was a placeholder. It
 * carries the JNI adapter now, so the desktop JVM runs the same format matrix the native targets do.
 */
