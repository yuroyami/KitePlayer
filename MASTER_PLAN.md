...
- [ ] The ring write asymmetry, two dead accessors, and the misattached ring KDoc.
...
- Observability: sequenced transitions, per-stage latency metrics (O2), trace export (O3).
  Structured logs with redaction exist.
