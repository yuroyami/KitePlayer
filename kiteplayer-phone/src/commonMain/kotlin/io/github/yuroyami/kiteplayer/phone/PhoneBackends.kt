...
/** Use [mobileBackends] from `kiteplayer`. */
@Deprecated("Use mobileBackends() from kiteplayer", ReplaceWith("mobileBackends()", "io.github.yuroyami.kiteplayer.mobile.mobileBackends"))
